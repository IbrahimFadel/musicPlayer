...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.songsLst = QtWidgets.QListWidget(self.centralwidget)
        self.songsLst.setGeometry(QtCore.QRect(50, 250, 256, 192))
        self.songsLst.setObjectName("songsLst")
    ...
    def play(self):
        global directory
        global songs
        index = self.songsLst.currentRow()
        print(index)
        pygame.mixer.music.load(directory + '/' + songs[index])
